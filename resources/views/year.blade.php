                            ...
                            <div class="wt-categorycontent">
                                <figure><img src="{{asset('img/'. $c->image_path)}}" alt="image description"></figure>
                                    <div class="wt-cattitle">
                                        <h3><a href="{{url('subject',['year_id'=>$year->id,'id'=>$c->id])}}">{{$c->name}}</a></h3>
                                    </div>
                                    <div class="wt-categoryslidup">
                                        <p>{{$c->description}}</p>
                                            <a href="{{url('subject',['year_id'=>$year->id,'id'=>$c->id])}}">Explore <i class="fa fa-arrow-right"></i></a>
                                    </div>
                            </div>
                        </div>
                    @endforeach
